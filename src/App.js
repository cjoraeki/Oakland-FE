        ...
        <Routes>
          ...
          <Route element={<RequireAdminAuth />}>
            <Route path="/admin" element={<Layout />}>
              ...
              <Route
                path="/admin/products"
                element={<TableView tableTitle={"PRODUCTS"} />}
              />
              <Route
                path="/admin/users"
                element={<PersonTableView tableTitle={"ALL USERS"} />}
              />
              <Route
                path="/admin/orders"
                element={<OrdersTableView tableTitle={"ALL ORDERS"} />}
              />
              <Route
                path="/admin/category"
                element={
                  <SubcategoryTableView
                    tableTitle={"CATEGORIES/SUBCATEGORIES"}
                  />
                }
              />
              <Route
                path="/admin/pickupCenter"
                element={<PickupTableView tableTitle={"ALL PICKUP CENTERS"} />}
              />
              <Route
                path="/admin/delivery"
                element={<PickupTableView tableTitle={"ALL PICKUP CENTERS"} />}
              ...
              <Route
                path="/admin/states"
                element={<StatesTableView tableTitle={"ALL STATES"} />}
              />
            </Route>
          </Route>
